...
def ls_main(message, bot):
	...
	for file in response_arr:
		...
		if len(ls) == index + 1:
			# сюда
			last_symbol = '╚══ '
		# название файла/папки получаем распарсив запись в массив по знаку "/" , и вытащив из него последнюю запись 
		...
		# добавляем к этой записе знак '└── ' (или '├── ') и добавляем название файла/папки
		# добавляем емоджи проверкой файл это или нет
